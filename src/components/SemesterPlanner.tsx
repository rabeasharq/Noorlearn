...
const ACADEMIC_CURRICULUM: Record<string, Record<string, TextbookLesson[]>> = {
  "7": {
    "1": [
      {
        unit: "الوحدة الأولى: أصالة الهوية",
        topic: "درس حب الوطن ومآثر الأجداد",
        aspects: {
          grammar: "أقسام الكلام وأنواعه",
          texts: "قصيدة 'موطني' للشاعر إبراهيم طوقان",
          reading: "شواهد 'اليمن السعيد' وجاذبية الجغرافيا",
          dictation: "التاء المربوطة والتاء المفتوحة",
          calligraphy: "خط النسخ بمحاكاة السطر",
          expression: "صياغة المنهجية العامة للتعبير"
        }
      },
      {
        unit: "الوحدة الثانية: معالم خالدة",
        topic: "بناء السدود والري التاريخي في اليمن",
        aspects: {
          grammar: "المعرب والمبني من الأسماء",
          texts: "مقطوعة 'تغريدة سبأ' الأدبية",
          reading: "قراءة تحليلية 'سد مأرب العظيم'",
          dictation: "التنوين والفرق بينه وبين النون الساكنة",
          calligraphy: "كتابة الحروف الصاعدة في النسخ",
          expression: "كتابة المقدمة الجاذبة للموضوع"
        }
      },
      {
        unit: "الوحدة الثالثة: التماسك الاجتماعي",
        topic: "التعاون والتآخي وثقافة البنيان",
        aspects: {
          grammar: "علامات الإعراب الأصلية (الرفع والنصب)",
          texts: "شعر 'الحق والقوة' للأدب الجمالي",
          reading: "التعاون والتآزر المجتمعي في الأرياف يمنيا",
          dictation: "الألف اللينة في أواخر الحروف",
          calligraphy: "موازين الحروف في سطر النسخ",
          expression: "تطوير عناصر المضمون واستحضار الحجج"
        }
      },
      {
        unit: "الوحدة الرابعة: منارات الحكمة",
        topic: "الحكمة اليمانية وتفصيل مكارم الأخلاق",
        aspects: {
          grammar: "علامات الإعراب الأصلية (الجر والسكون)",
          texts: "قصيدة 'أنا يمني' ملحمة بلقيس وصنعاء",
          reading: "قراءة استيعابية 'معدن الأخلاق الأصيل'",
          dictation: "همزة القطع في الأسماء والحروف",
          calligraphy: "خط الرقعة: القوانين الأساسية",
          expression: "الخاتمة الإنشائية الراقية والمؤثرة"
        }
      },
      {
        unit: "الوحدة الخامسة: عبق التاريخ",
        topic: "المدن اليمنية القديمة وطرازها الإنساني",
        aspects: {
          grammar: "الجملة الاسمية وركناها الأساسيان",
          texts: "نثر بليغ في وصف 'شبام حضرموت'",
          reading: "رحلة شيقة عبر 'أزقة صنعاء القديمة'",
          dictation: "همزة الوصل وسياقات النطق الصحيح",
          calligraphy: "ارتكاز خط الرقعة على السطر",
          expression: "التأليف والدمج التعبيري من البيئة"
        }
      },
      {
        unit: "الوحدة السادسة: همم العمل",
        topic: "سواعد العمال والصناعات الحرفية التقليدية",
        aspects: {
          grammar: "الفاعل وعلامات رفعه الظاهرة والفرعية",
          texts: "نشيد 'صانع الأمل' لفرسان الإعمار",
          reading: "القراءة الاستكشافية 'العطاء الاجتماعي'",
          dictation: "تطبيق حذف همزة 'ابن' وإثباتها",
          calligraphy: "تداخل الحروف في خط الرقعة وميلها",
          expression: "تنظيم الأفكار على لوحة المسودة"
        }
      },
      {
        unit: "الوحدة السابعة: توازن ونماء",
        topic: "البيئة والماء ثروة الأجيال وصون المستقبل",
        aspects: {
          grammar: "المفعول به وعلامات نصبه المختلفة",
          texts: "قصيدة 'شدو العصافير في الحقول'",
          reading: "توزيع المدرجات الجبلية والزراعة العضوية",
          dictation: "كتابة الهمزة المتوسطة على الألف",
          calligraphy: "مقارنة حية بين حركات النسخ والرقعة",
          expression: "كتابة موضوع متكامل عن حماية المياه"
        }
      },
      {
        unit: "الوحدة الثامنة: آفاق الأدب",
        topic: "الحكايات الشعبية والدروس التربوية الموروثة",
        aspects: {
          grammar: "المبتدأ والخبر وتطابقهما النحوي",
          texts: "رواية 'الفلاح والملك الحكيم' رمزية بليغة",
          reading: "تفنيد نقد الأدب الشعبي اليمني التراثي",
          dictation: "كتابة الهمزة المتوسطة على الواو",
          calligraphy: "تصميم لوحة خطية متناسقة وهادئة",
          expression: "النقد الزميلي المتبادل للمفردات الإنشائية"
        }
      }
    ],
    "2": [
      {
        unit: "الوحدة الأولى: المعرفة ريادة",
        topic: "القراءة والاطلاع رداء المجد والتقدم",
        aspects: {
          grammar: "النواسخ النحوية: إن وأخواتها وحروفها",
          texts: "قصيدة 'درب العلم' لجيل المستقبل والهمة",
          reading: "سياحة أدبية في 'سقطرى درة المحيط'",
          dictation: "الهمزة المتوسطة على ياء (نبرة)",
          calligraphy: "خط النسخ: الاتساق الزاوي للكتابة",
          expression: "صناعة أدوات التلخيص الذاتي للفقرة"
        }
      },
      {
        unit: "الوحدة الثانية: موارد الأوطان",
        topic: "أهم الموانئ اليمنية ومكانتها في طرق الملاحة",
        aspects: {
          grammar: "النواسخ النحوية: كان وأخواتها وأفعالها",
          texts: "سرد أدبي من 'شواطئ عدن البليغة'",
          reading: "قراءة نقدية 'ميناء المخا وتاريخ البن الأصيل'",
          dictation: "حالات استثنائية في رسم الهمزات المتوسطة",
          calligraphy: "مسارات القلم في كتابة حروف العين والغين",
          expression: "استعمال الروابط وأدوات الربط المناسبة"
        }
      },
      {
        unit: "الوحدة الثالثة: البناء الأسري",
        topic: "الأسرة وبناء جدار الثقة والطمأنينة الاجتماعية",
        aspects: {
          grammar: "الضمائر المنفصلة وعلامات بنائها ودلالتها",
          texts: "قصيدة 'الأم والطفل اليماني' للشاعر مطهر الإرياني",
          reading: "دور الترابط الأسري في تيسير تحديات المعيشة",
          dictation: "الألف اللينة في أواخر الأفعال الثلاثية",
          calligraphy: "حروف خط الرقعة المطمئنة والمغلقة",
          expression: "كتابة رسائل الشكر والتقدير التربوي"
        }
      },
      {
        unit: "الوحدة الرابعة: معالم وبطولات",
        topic: "قلاع اليمن وحصونها الشاهدة على الصمود والنماء",
        aspects: {
          grammar: "الضمائر المتصلة بالأسماء والأفعال والحروف",
          texts: "أبيات أدبية 'عرش بلقيس وقانون العدالة'",
          reading: "شواهد 'حصن الغويزي' وبراعة العمارة التشكيلية",
          dictation: "الألف اللينة في الأفعال غير الثلاثية",
          calligraphy: "نقاط ارتكاز وقواعد امتداد السين والشين",
      ...
      },
      {
        ...
        aspects: {
          grammar: "أسماء الإشارة للقرابة والبعد ودلالتها النحوية",
          texts: "جماليات النثر اليمني في وصف الفلكلور الشعبي",
          reading: "قراءة مقارنة 'توارث حرفة صياغة الفضة'",
          dictation: "الهمزة المتطرفة على السطر وفي الكلمة",
      ...
      },
      {
        ...
        aspects: {
          ...
          reading: "استخدام الحاسوب الميسر في ردم الفجوات اللغوية",
  ...
  "8": {
    "1": [
      {
        unit: "الوحدة الأولى: البناء والعلم",
        topic: "دور المعلم ومراكز التنوير في استنهاض الهمم",
        aspects: {
          grammar: "الأسماء الخمسة وشروط إعرابها بالحروف",
          texts: "مقتطفات من قصيدة أحمد شوقي 'قم للمعلم'",
          reading: "المكتبات والجامعات اليمنية القديمة (تريم رائدة)",
          dictation: "همزتا القطع والوصل في الأفعال ومصادرها",
          calligraphy: "خط الرقاع وتطبيقه الدقيق المباشر",
          expression: "كتابة المسودات وصقل موضوع التكريم اللغوي"
        }
      },
      {
        unit: "الوحدة الثانية: الاقتصاد المنزلي",
        topic: "البركة في الكسب الحلال والمدر الثري المعطاء",
        aspects: {
          grammar: "الفعل المضارع المنصوب وحروف النصب الذكية",
          texts: "مقطوعة 'همة المجد وسواعد الإنتاج'",
          reading: "زراعة الغلات الغذائية المحلية وصناعة الاكتفاء",
          dictation: "رسم الهمزة المتوسطة المنفردة على السطر",
          calligraphy: "أبعاد حرف الميم والنون في سطر النسخ الشاهد",
          expression: "كتابة الحجج الإيجابية وتنظيم محاور الادخار"
        }
      },
      {
        unit: "الوحدة الثالثة: الهوية والخصائص",
        topic: "الشيم العربية ومكارم الوفاء وعقود الجوار الفردي",
        aspects: {
          grammar: "الفعل المضارع المجزوم وأدوات الجزم الأحادية",
          texts: "قصيدة 'لغة الضاد' فصاحة وحماية أدبية عتيدة",
          reading: "أوليات 'المروءة والصدق وإغاثة الملهوف في مجتمعنا'",
          dictation: "زيادة حرفي الواو والألف في سياقات لغوية خاصة",
          calligraphy: "تقابل النسخ والرقعة في تشكيلات الحروف المتقاربة",
          expression: "رسائل النصح والإرشاد الأخلاقي التربوي الفصيح"
        }
      }
    ],
    "2": []
